...
typealias TypeViewControllerBlock = (type:String,detailType:String)->Void

class LLTypeViewController: UIViewController, IGLDropDownMenuDelegate {
    ...
    var type = "文学"
    var detailType = "文学"
    var callBack:TypeViewControllerBlock?
    ...
    override func viewDidLoad() {
        ...
        segmentLabel.textColor = RGB(82, g: 113, b: 13)
    ...
    func initSegment(){
        ...
        let buttonArray2 = [
            ...
            ["image":"alien masks","title":"科技","font":MY_FONT],
    ...
    */
    ...
    func createDropMenu(array1:Array<NSDictionary>,array2:Array<NSDictionary>){
        ...
        // 字体大小自适应（当文字较多时，字体就会变小来适应label的大小）
        ...
        self.dropDownMenu1?.type = .Stack // 设置动画
        self.dropDownMenu1?.itemAnimationDelay = 0.1 // 设置动画延迟时间
